...
<script src="https://www.google.com/recaptcha/api.js?render=6LcoK_cZAAAAALN4KhYDSk1ipz4x2wZIQo_N7bou"></script>
<script>
      function onClick(e) {
        e.preventDefault();
        grecaptcha.ready(function() {
          grecaptcha.execute('6LcoK_cZAAAAALN4KhYDSk1ipz4x2wZIQo_N7bou', {action: 'submit'}).then(function(token) {
...
<form id="lead" method="post" action="/clients-pro/">
...
<option value="">Please Select</option>
  ...
  <input type="text" id="DOB" name="DOB" title="Please enter date of birth"></div>
<div class="clear-float"></div> 
...
<select name="Services" id="Services" title="Please enter services">
<option value="">Please Select</option>
...
<div class="double-col"><input type="submit" value="Submit" class="form-btn"></div><div class="double-col"><input type="reset" value="Reset" class="reset-btn"></div>
<div class="clear-float"></div> 	 
</form>
