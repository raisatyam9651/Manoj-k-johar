...
<meta property="og:image" content="https://www.theaesthetic.in/images/news-article.jpg" />
...
<div id="Container"> 
  ...
  <div id="Banner-Container-S" role="presentation"> 
    <div id="Banner">
    <div class="navigation"><a href="/"><?php echo $breadCrumbHomeTitle; ?></a> <?php echo $breadCrumbSeparator; ?> {pagelet_breadcrumb}</div>
     <h1>{title}</h1>
      </div>
    </div>
      ...
      <div class="table-div">
        <div id="Content" class="table-cell">
          ...
          <article class="textMain ypocms">
                            <div class="blogMain">{pagelet_content}</div>
          </article>
         </div>
