<?php
	...
	$pageHeading = "Online Appointment";
...
<meta charset="utf-8">
  <?php
$pageTitle = 'Online Appointment - Dr. Manoj K. Johar | Cosmetic Surgeon Delhi NCR | Noida';

$pageDescription = 'Please fill the online appointment form to meet our cosmetic surgeon, Dr. Manoj K. Johar in Delhi and Ghaziabad, Noida in Uttar Pradesh. ';
$pagekeywords = 'online appointment - Dr. Manoj K. Johar, cosmetic surgeons';
$canonicalurl ='https://www.theaesthetic.in/online-appointment-plastic-reconstructive-surgeon-noida-up/';

$ogtitle = 'Online Appointment - Dr. Manoj K. Johar | Cosmetic Surgeon Delhi NCR | Noida';
...
$ogurl ='https://www.theaesthetic.in/online-appointment-plastic-reconstructive-surgeon-noida-up/';
        ...
        <div id="Content" class="table-cell">
          ...
          <article class="textMain ypocms">
            <h2>Online Appointment</h2>
                            ...
                            <script src="https://forms.yourpractice.online/MG1LMytzMk1WOExXeGt6YmNYWlY1UT09OjrV40OLKpLuSxvJ29pzDFUlfSlAsHC4/" type="text/javascript"></script>
