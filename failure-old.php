...
h2 {
	font: normal 20px/30px Verdana, Arial, Helvetica, sans-serif !important;
}
}
</style>
</head>
    ...
    <div id="Content-Main">
      <div class="table-div">
        ...
        <div class="thankYou">
                                 ...
                                 <div class="alertImg"><i class="fa fa-exclamation-circle" style="font-size:100px;color:red"></i></div>

                                <h2 class="ctr blk">Something went wrong!</h2>
								<p><a href="/online-enquiry-form/">Please try again</a></p>
                                 </div>
