<?php
	...
	$pageHeading = "General Appointment";
...
<meta charset="utf-8">
  ...
  <?php
$pageTitle = 'General Appointment - Dr Manoj Johar | Plastic Surgeon Delhi NCR | Noida';

$pageDescription = 'Please call 85277 79525 for any enquiries and to fix an appointment with plastic surgeon, Dr. Manoj K. Johar in Delhi and Ghaziabad, Noida in Uttar Pradesh.';
$pagekeywords = 'general appointment for plastic surgeon"';
$canonicalurl ='https://www.theaesthetic.in/general-appointment-plastic-reconstructive-surgeon-noida-up/';

$ogtitle = 'General Appointment - Dr Manoj Johar | Plastic Surgeon Delhi NCR | Noida';

$ogdescription= 'Please call 85277 79525 for any enquiries and to fix an appointment with plastic surgeon, Dr. Manoj K. Johar in Delhi and Ghaziabad, Noida in Uttar Pradesh.';

$ogurl ='https://www.theaesthetic.in/general-appointment-plastic-reconstructive-surgeon-noida-up/';
...
<div id="Container"> 
  ...
  <div id="Content-Container" data-skip="Content">
	...
	<h2 class="dr-name">Dr. Johar’s Plastic Surgery Group</h2>
							<p>For all appointments and inquiries, please call <span class="tel1 textMainBold"></span> or <span class="btn"><a href="/online-appointment-plastic-reconstructive-surgeon-noida-up/">click here</a></span> to request an appointment online.</p>
