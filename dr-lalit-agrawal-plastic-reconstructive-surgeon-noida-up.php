...
$pageTitle = 'Dr Lalit Agrawal | Senior Consultant Plastic and Reconstructive Surgeon Delhi, Ghaziabad, Noida';
$pageDescription = 'Dr Lalit Agrawal is a senior consultant plastic and reconstructive surgeon in Delhi and Ghaziabad, Noida in Uttar Pradesh. He specialising in various reconstructive and cosmetic procedures like fat grafting, gynecomastia, breast reconstruction/ corrections, body contouring, rhinoplasty with focus on natural look results.';
$pagekeywords = 'Dr. Lalit Agrawal, plastic surgeon, Best Plastic Surgeon in Noida, Best Plastic Surgeon in Delhi NCR, Best Plastic Surgeon in Vaishali, Best Plastic Surgeon in East Delhi, reconstructive surgeon, plastic surgery, cancer reconstruction surgery, amputation prevention, breast surgery, cancer reconstruction surgery, children plastic surgery, cleft and craniofacial surgery, facial plastic surgery, maxillofacial surgery, lymphedema';
$canonicalurl ='https://www.theaesthetic.in/dr-kamlesh-kumar-plastic-reconstructive-surgeon-noida-up/';
$ogtitle = 'Dr Lalit Agrawal | Senior Consultant Plastic and Reconstructive Surgeon Delhi, Ghaziabad, Noida';
$ogdescription= 'Dr Lalit Agrawal is a senior consultant plastic and reconstructive surgeon in Delhi and Ghaziabad, Noida in Uttar Pradesh. He specialising in various reconstructive and cosmetic procedures like fat grafting, gynecomastia, breast reconstruction/ corrections, body contouring, rhinoplasty with focus on natural look results.';
...
$twdescription='Dr. Lalit Agrawal is the best plastic surgeon in Noida, Ghaziabad and Delhi NCR. He is a highly skilled and experienced plastic surgeon.';
...
$listidname = 'Dr. Lalit Agrawal, plastic surgeon, Best Plastic Surgeon in Noida, Best Plastic Surgeon in Delhi NCR';
$templatename = 'Dr. Lalit Agrawal, plastic surgeon, Best Plastic Surgeon in Noida, Best Plastic Surgeon in Delhi NCR';
?>
                ...
                <div class="table-div">
                    <div id="Content" class="table-cell">
                        ...
                        <article class="textMain ypocms dr-profile-pg">
                            ...
                            <div class="img-r">
                                <img class="lazyload" src="#" data-src="<?php echo IMG_PATH; ?>lalit-agarwal-profile1.jpg" alt="Dr. Lalit Agrawal">
                            </div>
                            <h2>Dr. Lalit Agrawal</h2>
                            <h3>Senior Consultant – Department of Plastic Surgery</h3>
                            
                            <p>Dr. Lalit Agrawal is a Senior Consultant Plastic and Reconstructive Surgeon. For Dr. Agrawal, Plastic surgery is where technical excellence meets artistic intuition. Specialising in various reconstructive and cosmetic procedures like Fat grafting, gynecomastia, breast reconstruction/ corrections, body contouring, Rhinoplasty with focus on natural look results.</p>
