<?php
	...
	$pageHeading = "Know Your Estimate";
...
<meta charset="utf-8">
<?php
$pageTitle = 'Know Your Estimate | Dr. Johar, Plastic & Reconstructive Surgeon';
$pageDescription = 'Click here to fill the form and submit a query for Dr. Manoj K. Johar- Plastic & Reconstructive Surgeon in Delhi, Ghaziabad, and Noida.';
...
$canonicalurl ='https://www.theaesthetic.in/know-your-estimate-plastic-reconstructive-surgeon-noida-up/';
$ogtitle = 'Know Your Estimate | Dr. Johar, Plastic & Reconstructive Surgeon';
$ogdescription= 'Click here to fill the form and submit a query for Dr. Manoj K. Johar- Plastic & Reconstructive Surgeon in Delhi, Ghaziabad, and Noida.';
$ogurl ='https://www.theaesthetic.in/know-your-estimate-plastic-reconstructive-surgeon-noida-up/';
...
<div id="Container"> 
  ...
  <div id="Content-Container" data-skip="Content">
    ...
    <h2 data-icon="&#xe800;">Know Your Estimate</h2>
	<p class="PDFtext">Fields marked (<span class="mandatory">*</span>) are required</p>
	<script src="https://forms.yourpractice.online/aVpKYjVYRTdLUHk3TU9MRzhFWlhJdz09OjrynE1MK25yVfxCOBWL8q8H/" type="text/javascript"></script>
