...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "Dr. Manoj Johar",
  "image": "https://www.theaesthetic.in//images/drmanojjhor-image.jp",
  "@id": "",
...
<header id="Header-Container" data-skip="Header">
  <div id="Header">
    <div class="table-div">
      ...
      <div class="table-cell logo"><a href='/' aria-label=""><img class="lazyload" src="#" data-src="<?php echo IMG_PATH; ?>dr-johar-logo-img.png" alt="dr-manoj-johar-logo"></a></div>
      <!--<div class="table-cell appoint"><a href="/online-appointment-plastic-reconstructive-surgeon-noida-up/">Book an Appointment</a></div>-->
      
       <div class="table-cell mob"> 
	   <div class="appoint"><a href="/online-appointment-plastic-reconstructive-surgeon-noida-up/">Book an Appointment</a></div>
