...
<meta charset="utf-8">
  <?php
$pageTitle = 'Your First Visit | Plastic Reconstructive Surgeon Delhi | Noida';

$pageDescription = 'Click here to know what to bring on your first visit with plastic reconstructive surgeon, Dr. Manoj K. Johar in Delhi and Ghaziabad, Noida.';
...
$canonicalurl ='https://www.theaesthetic.in/first-visit-plastic-reconstructive-surgeon-noida-up/';

$ogtitle = 'Your First Visit | Plastic Reconstructive Surgeon Delhi | Noida';

$ogdescription= 'Click here to know what to bring on your first visit with plastic reconstructive surgeon, Dr. Manoj K. Johar in Delhi and Ghaziabad, Noida.';

$ogurl ='https://www.theaesthetic.in/first-visit-plastic-reconstructive-surgeon-noida-up/';
    ...
    <div id="Content-Main">
      <div class="table-div">
        <div id="Content" class="table-cell">
          ...
          <p>When you come for your appointments, please bring the following</p>
							<ul>
