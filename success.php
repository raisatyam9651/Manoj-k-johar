...
<meta charset="utf-8">
  <?php
$pageTitle = 'Dr. Manoj K. Johar Online Enquiry Form submission successfull | Plastic & Reconstructive Surgeon Delhi Delhi';

$pageDescription = 'We are trying to make our website as helpful and informative as possible, so we need your feedback.';
$pagekeywords = 'dr. manoj k. johar online enquiry form submission successfull, plastic & reconstructive surgeon';
$canonicalurl ='https://www.theaesthetic.in/success/';

$ogtitle = 'Dr. Manoj K. Johar Online Enquiry Form submission successfull | Plastic & Reconstructive Surgeon Delhi NCR';

$ogdescription= 'We are trying to make our website as helpful and informative as possible, so we need your feedback.';

$ogurl ='https://www.theaesthetic.in/success/';
...
/></noscript>
<!-- End Meta Pixel Code -->
<style>@media screen and (max-width: 640px) {h2,h2 span {	font: normal 20px/30px Verdana, Arial, Helvetica, sans-serif !important;}}</style>
</head>
<body>
    ...
    <div id="Content-Main">
      <div class="table-div">
        <div id="Content" class="table-cell">
          <article class="textMain ypocms">                <div class="thankYou">                <div class="thankImg"></div>                                <h2>Thank <span>You!</span></h2>                                <p>We have received your request and will be contacting you shortly. If you have any further questions please call us at <span class="tel1"></span>.</p>                            </div>          </article>
