...
<meta charset="utf-8">
  <?php
$pageTitle = 'Dr. Manoj K. Johar Online Enquiry Form submission Failure | Plastic & Reconstructive Surgeon Delhi Delhi';

$pageDescription = 'We are trying to make our website as helpful and informative as possible, so we need your feedback.';
$pagekeywords = 'dr. manoj k. johar online enquiry form submission Failure, plastic & reconstructive surgeon';
$canonicalurl ='https://www.theaesthetic.in/failure/';

$ogtitle = 'Dr. Manoj K. Johar Online Enquiry Form submission Failure | Plastic & Reconstructive Surgeon Delhi NCR';

$ogdescription= 'We are trying to make our website as helpful and informative as possible, so we need your feedback.';

$ogurl ='https://www.theaesthetic.in/failure/';
...
/></noscript>
<!-- End Meta Pixel Code --><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<style>@media screen and (max-width: 640px) {h2 {	font: normal 20px/30px Verdana, Arial, Helvetica, sans-serif !important;}}</style>
</head>
<body>
    ...
    <div id="Content-Main">
      <div class="table-div">
        <div id="Content" class="table-cell">
          <article class="textMain ypocms">                <div class="thankYou">                                 <div class="alertImg"><i class="fa fa-exclamation-circle" style="font-size:100px;color:red"></i></div>                                <h2 class="ctr blk">Something went wrong!</h2>								<p><a href="/online-enquiry-form/">Please try again</a></p>                                 </div>          </article>
